    ...
    try {
      ...
      for (const report of response.data) {
        try {
          ...
          image_set.push(formattedImages);
        } catch (error) {
          console.error("Error fetching images for report:", error);
        }
      }
      setImages(image_set);
    } catch (error) {
            ...
            {reports.length > 0 && (
              <div className="report-view">
                <div className="navigation-buttons">
                  ...
                  <h4>{reports[currentReportIndex].date}</h4>
                  <button
                ...
                <AngiogramReportView1
                  ...
                  image_files={images[currentReportIndex] || []}
                />
              </div>
            )}
          </div>
